...
<header>
  <center><h1>The Travel Warrior</h1></center>
    ...
    <img src="<?php echo base_url()?>image/slidebean-jaOeFnmzfsw-unsplash.jpg" height="1000"  style="width:100%;" class="bg-img">

    <br><br><br>
    <center><h1>Enquiry Display</h1></center><br>
...
<body>
    ...
    <p>Address: Kolkata, Westbengal, India</p>
      ...
      <p class="copyright">The Travel Warrior © 2021</p>
         </div>
     </div>
    </div>
   </footer>
