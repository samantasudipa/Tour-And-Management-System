...
<header>
  <center><h1>The Travel Warrior</h1></center>
    ...
    <img src="<?php echo base_url()?>image/dan-nelson-ah-HeguOe9k-unsplash.jpg"  style="width:100%;" class="bg-img">
    <br><br><br>
    ...
    <form method="post" >
    <div style="background-color: #d3edda;">
      
    <div class="ex">
      <center><h2>Change password</h2></center><br>
  
      <label for="old"><b>Enter old password:</b></label>
    <input type="text" placeholder="old password" name="old"  required><br>

    <label for="new"><b>Enter new password:</b></label>
    <input type="text" placeholder="new password" name="new"  required><br>

    <label for="confirm"><b>Enter confirm password:</b></label>
    <input type="text" placeholder="confirm password" name="confirm"  required><br>
