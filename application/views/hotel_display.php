...
<header>
  <center><h1>The Travel Warrior</h1></center>
    ...
    <img src="<?php echo base_url()?>image/darshan-patel-Wx22AUU1bnw-unsplash.jpg" height="1000" style="width:100%;" class="bg-img">

    <br><br><br>
    <h1><center>Display hotel details</h1></center><br>
	...
	foreach($data as $row)
	{
      ...
      <td><?php echo $row->room_available?></td>
			<td><button style="background-color:#bfff00;"><a href="hotel_update_data?ep=<?php echo $row->user_id?>">Edit</a></button>
          <button style="background-color:#bfff00;"><a href="hotel_deletedata?del=<?php echo $row->user_id?>">Delete</a></button> 
			</td>
		</tr>
	<?php
	 }
