...
<center><h1>The Travel Warrior</h1></center>
 ...
 <div > 
    <ul>
      ...
      <li><a href="<?php echo base_url().'index.php/admin_controller/userDetails'?>">User Details</a></li>
      <li><a href="<?php echo base_url().'index.php/admin_controller/bookingDetails'?>">Booking Details</a></li>
    </ul>
    <img src="<?php echo base_url()?>image/burst-kUqqaRjJuw0-unsplash.jpg"  style="width:100%;" class="bg-img">

  <form method="post" >
    
       <br><br><br>
    <div class="ex">
      <h1><center>Feedback</center></h1><br>
    ...
    <label for="rate"><b>How do you rate our services</b></label><br>
    <input type="radio" name="rate" value="bad">Bad
    <input type="radio" name="rate" value="average">Average
     <input type="radio" name="rate" value="good">Good
      <input type="radio" name="rate" value="excellent">Excellent<br><br>
