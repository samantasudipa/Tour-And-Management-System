...
<header>
  <center><h1>The Travel Warrior</h1></center>
    ...
    <img src="<?php echo base_url()?>image/insung-yoon-SZgJl-cZ26k-unsplash.jpg"  style="width:100%;" class="bg-img">

    <br><br><br>
     <center><h1>User booking details</h1></center><br>
	...
	foreach($data as $row)
	{
      ...
      <td><?php echo $row->status?></td>
			<td><button style="background-color: #ffbf00;"><a href="admin_booking_update?bk=<?php echo $row->user_id?>">Update status</a></button>
			</td>
		</tr>
	<?php
	 }
