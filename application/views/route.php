...
<body id="b1">
  ...
  <form method="post" >
    ...
    <br><br><br>
    <div class="ex">
      <h1><center>Route Details</center></h1>

      <label for="from"><b>From</b></label>
    <input type="text" placeholder="From" name="from"  required><br><br>

    <label for="to"><b>To</b></label>
    <input type="text" placeholder="To" name="to"  required><br><br>

    <label for="fare"><b>Fare</b></label>
    <input type="text" placeholder="Fare" name="fare"  required><br><br>
    ...
    <input type="text" placeholder="pick up" name="pick"  required><br><br>
