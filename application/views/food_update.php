<!DOCTYPE html>
<html id="ht1">
<title>Food Details Update</title>
<head>
...
<header>
  <center><h1>The Travel Warrior</h1></center>
    ...
    <img src="<?php echo base_url()?>image/louis-hansel--9CjvlbUGhY-unsplash.jpg"  style="width:100%;" class="bg-img">
  ...
  foreach ($data as $row)
  {
    ...
    <input type="text" placeholder="Address" name="address"  required value="<?php echo $row->address ?>"><br><br>


    <label for="loc"><b>Location</b></label>
    <input type="text" placeholder="Location" name="loc"  required value="<?php echo $row->location ?>"><br><br>
    ...
    <select id="q1" name="food">
      ...
      <option value="Nonveg" <?php if($row->food_type=='Nonveg'){echo "selected";}?>>Nonveg</option>
      <option value="veg" <?php if($row->food_type=='Veg'){echo "selected";}?>>Veg</option>
    </select><br><br>
